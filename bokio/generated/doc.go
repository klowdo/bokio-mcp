...
//
// ponytail: oapi-codegen v1.16.3 rejects `format: decimal`; strip it first (number stays float32, same result).
//
//go:generate sh -c "sed -i '/^[[:space:]]*format: decimal$/d' ../../schemas/company-api.yaml ../../schemas/general-api.yaml"
